...
namespace common.Model
{
    ...
    public class ServiceModel
    {
        ...
        public void GetWeather(String Ciudad)
        {
            ...
            if (Ciudad == null)
            {
                   uri = String.Format("http://weather.service.msn.com/find.aspx?outputview=search&weadegreetype=C&culture=es-Es&weasearchstr={0}", "");     
            }
            else
            {              
                 uri = String.Format("http://weather.service.msn.com/find.aspx?outputview=search&weadegreetype=C&culture=es-Es&weasearchstr={0}", Ciudad);
            }
